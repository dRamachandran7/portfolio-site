/**
 * lucide-react v1 dropped brand glyphs, so GitHub and LinkedIn marks live here
 * as inline SVG. They accept the same props as a lucide icon (className sizes
 * them, fill follows currentColor).
 */
